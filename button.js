class Button {
  constructor(posX, posY, width, height, text, colour = [31, 164, 204], showCircle = true, unlocked = true, rounded = 0, font = "Arial"){
  ...
  draw() {
    ...
    if(this.inside && this.showCircle) {circle(this.pos.x - 75, this.pos.y + this.rectSize.y / 2, 30)};
    stroke(3);
